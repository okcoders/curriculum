# Outside Class Work Schedule

## Material

- [Next js pages router](https://nextjs.org/docs/getting-started/installation)
- [Api routes with nextjs](https://nextjs.org/docs/pages/building-your-application/routing/api-routes)
- [Prisma](https://www.prisma.io/docs/getting-started/quickstart)
- [What is a database](https://medium.com/@rwilliams_bv/intro-to-databases-for-people-who-dont-know-a-whole-lot-about-them-a64ae9af712)
- [Intro to databases](https://www.digitalocean.com/community/conceptual-articles/an-introduction-to-databases)
